...
Most of this project will be based of the research of XXXXXXX who did a great job 6 years ago. When compiling his program i got errors and so i thougt about giving the old approach an overhaul by reviewing the code to be readable and easy and most important to change the initialization prozess from bluetooth serial to an lightweigt webserver baser approach.
